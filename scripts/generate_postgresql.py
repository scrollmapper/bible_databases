...
from generators.postgresql.postgresql_generator import PostgreSQLGenerator
...
def main():
    ...
    postgresql_generator = PostgreSQLGenerator(source_directory, format_directory)
    postgresql_generator.generate(language, translation)
