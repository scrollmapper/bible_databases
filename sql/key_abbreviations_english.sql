...
CREATE TABLE `key_abbreviations_english` (
  `id` smallint(1) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Abbreviation ID',
  `a` varchar(251) NOT NULL,
  `b` smallint(1) unsigned NOT NULL COMMENT 'ID of book that is abbreviated',
